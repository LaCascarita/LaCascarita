    ...
    <div className="min-h-screen bg-[#0B0B0B] flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <Link to="/login" className="inline-flex items-center gap-3 text-2xl sm:text-3xl font-bold text-white hover:text-emerald-400 transition-colors">
            <img src="/logo_cascarita.svg" alt="La Cascarita" className="h-14 w-14 sm:h-16 sm:w-16" />
