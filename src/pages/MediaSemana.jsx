...
const MediaSemana = () => {
  ...
  const matches = [
    { id: 1, home: 'Monterrey', away: 'Tigres', date: 'Miércoles 20:00' },
    { id: 2, home: 'América', away: 'Chivas', date: 'Miércoles 22:00' },
    { id: 3, home: 'Cruz Azul', away: 'Pumas', date: 'Jueves 19:00' },
    { id: 4, home: 'Santos', away: 'León', date: 'Jueves 21:00' },
    { id: 5, home: 'Puebla', away: 'Querétaro', date: 'Jueves 21:00' },
    { id: 6, home: 'Toluca', away: 'Necaxa', date: 'Jueves 21:00' },
    { id: 7, home: 'Atlas', away: 'Mazatlán', date: 'Jueves 21:00' },
    { id: 8, home: 'Juárez', away: 'San Luis', date: 'Jueves 21:00' },
    { id: 9, home: 'Rayados', away: 'Tijuana', date: 'Jueves 21:00' },
  ]
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between mb-6 sm:mb-8 gap-4">
          <div className="text-center sm:text-left">
            ...
            <p className="text-slate-400 mt-2">9 partidos • Cierre: Miércoles 20:00</p>
          </div>
